        ...
        <PageContainer>
            ...
            <MainContent>
                <AnimatePresence mode="wait">
                    ...
                    >
                        <OverlayIcon right initial={{ opacity: 0 }} animate={{ opacity: exitX > 0 ? 0.8 : 0 }}>
                            <FavoriteIcon fontSize="inherit" />
                        </OverlayIcon>
                        <OverlayIcon initial={{ opacity: 0 }} animate={{ opacity: exitX < 0 ? 0.8 : 0 }}>
                            <CloseIcon fontSize="inherit" />
                        </OverlayIcon>
                        <StyledAvatar>
                            <PersonIcon fontSize="large" />
                        </StyledAvatar>
                        <Typography variant="h6" fontWeight={600} textAlign="center">{profile.name}</Typography>
                        <Typography variant="subtitle2" textAlign="center" color="text.secondary">
                            만 {profile.age} · {profile.mbti}
                        </Typography>
                        <Typography variant="body2" textAlign="center" gutterBottom>{profile.nickname}</Typography>
                        ...
                        <Box display="flex" justifyContent="center" gap={4} mt={3}>
                            <StyledActionButton onClick={handleDislike}><CloseIcon /></StyledActionButton>
                            <StyledActionButton onClick={handleLike}><FavoriteIcon color="error" /></StyledActionButton>
                        </Box>
                    </StyledMatchingCard>
                </AnimatePresence>
            </MainContent>
